...
class JsearchApiWrapper:
    ...
    def accounts_logs(self, address, limit=None, offset=None, order=None):
        uri = f'/accounts/{address}/logs'
        query_params = dict(limit=limit, offset=offset, order=order)
        return self.client.get(uri, query_params=query_params)

    def accounts_transactions(self, address, tag=None, limit=None, offset=None):
        uri = f'/accounts/{address}/transactions'
        query_params = dict(tag=tag, limit=limit, offset=offset)
        return self.client.get(uri, query_params=query_params)

    def accounts_internal_transactions(self, address, tag=None, limit=None, offset=None):
        uri = f'/accounts/{address}/internal_transactions'
        query_params = dict(tag=tag, limit=limit, offset=offset)
        return self.client.get(uri, query_params=query_params)

    def accounts_pending_transactions(self, address, tag=None, limit=None, offset=None):
        uri = f'/accounts/{address}/pending_transactions'
        query_params = dict(tag=tag, limit=limit, offset=offset)
        return self.client.get(uri, query_params=query_params)

    def accounts_mined_blocks(self, address, limit=None, offset=None, order=None):
        uri = f'/accounts/{address}/mined_blocks'
        query_params = dict(limit=limit, offset=offset, order=order)
        return self.client.get(uri, query_params=query_params)

    def accounts_mined_uncles(self, address, limit=None, offset=None, order=None):
    ...
    def accounts_token_transfers(self, address, limit=None, offset=None, order=None):
    ...
    def uncles(self, limit=None, offset=None, order=None):
        uri = '/uncles'
        query_params = dict(limit=limit, offset=offset, order=order)
        return self.client.get(uri, query_params=query_params)
    ...
    def tokens_transfers(self, address, limit=None, offset=None, order=None):
        uri = f'/tokens/{address}/transfers'
        query_params = dict(limit=limit, offset=offset, order=order)
        return self.client.get(uri, query_params=query_params)

    def tokens_holders(self, address, limit=None, offset=None, order=None):
...
class Etherscan():
    ...
    def getLogs(self, address, fromBlock=1, toBlock="latest", topics=None):
        query_params = {
            "module": "logs",
            "action": "getLogs",
            "fromBlock": fromBlock,
        ...
        if topics is not None:
            ...
            for idx, item in enumerate(topics):
                appendix['topic%s' % idx] = item
            query_params.update(appendix)

        status_code, response = self.client.get('', query_params=query_params)
        return response["result"]

    def _get_mined(self, address, what, page=None, offset=None):
        query_params = {
            "module": "account",
    ...
    def get_mined_blocks(self, address, page=None, offset=None):
        return self._get_mined(address, "blocks", page, offset)

    def get_mined_blocks_numbers(self, address, page=None, offset=None):
        result = self.get_mined_blocks(address, page, offset)
        return [int(item['blockNumber']) for item in result]

    def get_mined_uncles(self, address, page=None, offset=None):
        return self._get_mined(address, "uncles", page, offset)

    def get_mined_uncles_numbers(self, address, page=None, offset=None):
        result = self.get_mined_uncles(address, page, offset)
        return [int(item['blockNumber']) for item in result]
