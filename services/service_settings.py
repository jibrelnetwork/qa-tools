...
SLACK_TO_PORTAINER_HOOK_TIMEOUT = int(os.getenv("SLACK_OBJ_TTL", 120))
SLACK_TOKEN = os.getenv("SLACK_TOKEN", 'xoxb-186470154240-813908724099-bK3asCsiM6XZ3Dc8TkFmJr3p')
